...
```{r message= TRUE, warning=FALSE}
ggplot(sPor,aes(x=studytime,fill=mark))+geom_histogram(binwidth = 2)+ylab("Frecuencia")+facet_wrap(~sex )
ggplot(sPor,aes(x=studytime,fill=mark))+geom_bar()+ylab("Frecuencia")+facet_wrap(~sex )
```

```{r message= TRUE, warning=FALSE}
ggplot(sPor,aes(x=mark,fill=famsize))+geom_bar()+ylab("Frecuencia")+facet_wrap(~sex )
ggplot(sPor,aes(x=mark,fill=famsize))+geom_bar(position='fill')+ylab("Frecuencia")+facet_wrap(~sex )
```
